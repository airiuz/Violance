                ...
                if len(plate_coord) > 0:
                    ...
                    if len(plate_number) == 8:
                        ...
                        if cursor.fetchall()[0][0] == 0:
                            ...
                            cursor.execute("INSERT INTO avtomobil(path, number, vaqt) VALUES(?, ?, ?)",
                                           (path, plate_number, time))
                            baza.commit()
...
Violence.objects.create(frame=frame,
                        numbers_car_frame=numbers_car_frame,
